"""Single-use Q02-first real validation entry for tool-routing Prompt v2."""
...
from src.tool_routing_prompt_v2_real_runner import (  # noqa: E402
    execute_validation_v2,
    validate_real_request_v2,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v2(
