"""Run the single-use combined Prompt v12 Q04 checkpoint."""
...
from src.combined_prompt_v12_real_runner import (  # noqa: E402
    execute_validation_v12,
    validate_real_request_v12,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v12(
            model=args.model,
