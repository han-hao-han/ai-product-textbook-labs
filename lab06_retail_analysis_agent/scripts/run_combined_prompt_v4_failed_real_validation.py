"""Run the single-use combined Prompt v4 failed-question checkpoint."""
...
from src.combined_prompt_v4_real_runner import (  # noqa: E402
    execute_validation_v4,
    validate_real_request_v4,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v4(
            model=args.model,
