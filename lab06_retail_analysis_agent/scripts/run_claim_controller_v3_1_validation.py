"""Run V3.1 offline or authorized real validation."""
...
from src.claim_controller_v3_1_real_runner import (  # noqa: E402
    execute_validation_v3_1_checkpoint,
    execute_validation_v3_1_full,
    validate_real_request_v3_1_checkpoint,
    validate_real_request_v3_1_full,
)
from src.claim_level_report_controller_mock_v3_1 import ClaimTemplateLogicalClientV3_1  # noqa: E402
...
from src.tool_routing_prompt_v1_real_runner import ToolRoutingAuthority  # noqa: E402
...
def main() -> int:
    ...
    executor = execute_validation_v3_1_checkpoint if args.scope == "checkpoint" else execute_validation_v3_1_full
    if args.mode == "offline":
        ...
        validator = validate_real_request_v3_1_checkpoint if args.scope == "checkpoint" else validate_real_request_v3_1_full
        authority = validator(
            model=args.model,
