"""Run a single-use v18 Q04 checkpoint or Q01-Q10 validation."""
...
from src.combined_prompt_v18_real_runner import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--scope", choices=("q04", "full"), required=True)
    ...
    validator = validate_real_request_v18_q04 if args.scope == "q04" else validate_real_request_v18_full
    executor = execute_validation_v18_q04 if args.scope == "q04" else execute_validation_v18_full
    try:
        authority = validator(
