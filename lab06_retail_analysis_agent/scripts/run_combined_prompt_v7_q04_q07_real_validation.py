"""Run the single-use combined Prompt v7 Q04/Q07 checkpoint."""
...
from src.combined_prompt_v7_real_runner import (  # noqa: E402
    execute_validation_v7,
    validate_real_request_v7,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v7(
            model=args.model,
