"""Run the V14 Q04 checkpoint with bounded terminal corrections."""
...
from src.combined_prompt_v14_real_runner import (  # noqa: E402
    execute_validation_v14,
    validate_real_request_v14,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v14(
            model=args.model,
