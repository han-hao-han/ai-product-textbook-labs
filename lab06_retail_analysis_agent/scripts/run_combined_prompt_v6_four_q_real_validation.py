"""Run the single-use combined Prompt v6 four-question checkpoint."""
...
from src.combined_prompt_v6_real_runner import (  # noqa: E402
    execute_validation_v6,
    validate_real_request_v6,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v6(
            model=args.model,
