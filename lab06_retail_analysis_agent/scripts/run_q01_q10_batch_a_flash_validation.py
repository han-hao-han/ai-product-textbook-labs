"""Real-entry shell for the frozen batch-A Flash runner.

The current frozen plan has no real-call authority, so this entry defaults
to rejection before the API key is read.
"""
...
def main() -> int:
    ...
    except BatchASafeRunnerError as exc:
