"""Run the single-use combined Prompt v10 Q04/Q05 checkpoint."""
...
from src.combined_prompt_v10_real_runner import (  # noqa: E402
    execute_validation_v10,
    validate_real_request_v10,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v10(
            model=args.model,
