"""Run the single-use combined Prompt v5 four-question checkpoint."""
...
from src.combined_prompt_v5_real_runner import (  # noqa: E402
    execute_validation_v5,
    validate_real_request_v5,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v5(
            model=args.model,
