"""Run the single-use combined Prompt v8 Q04 checkpoint."""
...
from src.combined_prompt_v8_real_runner import (  # noqa: E402
    execute_validation_v8,
    validate_real_request_v8,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v8(
            model=args.model,
