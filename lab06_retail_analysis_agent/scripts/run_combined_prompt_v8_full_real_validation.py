"""Run the single-use combined Prompt v8 Q01-Q10 final validation."""
...
from src.combined_prompt_v8_full_real_runner import (  # noqa: E402
    execute_validation_v8_full,
    validate_real_request_v8_full,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v8_full(
            model=args.model,
