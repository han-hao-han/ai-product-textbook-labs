"""Run the single-use combined Prompt v16 Q01-Q10 validation."""
...
from src.combined_prompt_v16_full_real_runner import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v16_full(
            model=args.model,
