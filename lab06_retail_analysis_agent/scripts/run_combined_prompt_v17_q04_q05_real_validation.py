"""Run the single-use combined Prompt v17 Q04/Q05 validation."""
...
from src.combined_prompt_v17_q04_q05_real_runner import (  # noqa: E402
    execute_validation_v17_q04_q05,
    validate_real_request_v17_q04_q05,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v17_q04_q05(
            model=args.model,
