"""Single-use real Q02 entry for V2.3.4.1."""
...
from src.q02_section_purpose_v2_3_4_1_runner import (  # noqa: E402
    Q02SectionPurposeRunnerError, execute_q02, validate_real_execution_request,
)
...
def main() -> int:
    ...
    except Q02SectionPurposeRunnerError as exc:
