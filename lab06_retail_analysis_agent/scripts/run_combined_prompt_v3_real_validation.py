"""Single-use real validation entry for combined Prompt v3."""
...
from src.combined_prompt_v3_real_runner import (  # noqa: E402
    execute_validation_v3,
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v3(
            model=args.model,
