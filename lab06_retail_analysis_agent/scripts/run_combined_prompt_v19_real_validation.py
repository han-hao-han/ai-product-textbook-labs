"""Run the v19 Q01/Q06 checkpoint or Q01-Q10 full validation."""
...
from src.combined_prompt_v19_real_runner import (  # noqa: E402
    execute_validation_v19_checkpoint, execute_validation_v19_full,
    validate_real_request_v19_checkpoint, validate_real_request_v19_full,
)
...
def main() -> int:
    ...
    validator = validate_real_request_v19_checkpoint if args.scope == "checkpoint" else validate_real_request_v19_full
    executor = execute_validation_v19_checkpoint if args.scope == "checkpoint" else execute_validation_v19_full
    try:
        authority = validator(
