"""Run the V15 Q04 checkpoint with local REQUEST-value completeness."""
...
from src.combined_prompt_v15_real_runner import (  # noqa: E402
    execute_validation_v15,
    validate_real_request_v15,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v15(
            model=args.model,
