"""Guarded real entry for the Q02 V2.3.2 claim-evidence checkpoint."""
...
from src.q02_claim_evidence_bundle_v2_3_2_runner import (  # noqa: E402
...
def main() -> int:
    ...
    except Q02ClaimEvidenceV2_3_2RunnerError as exc:
