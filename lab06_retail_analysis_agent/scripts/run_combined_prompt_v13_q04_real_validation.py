"""Run the V13 Q04 checkpoint with one bounded semantic correction."""
...
from src.combined_prompt_v13_real_runner import (  # noqa: E402
    execute_validation_v13,
    validate_real_request_v13,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v13(
            model=args.model,
