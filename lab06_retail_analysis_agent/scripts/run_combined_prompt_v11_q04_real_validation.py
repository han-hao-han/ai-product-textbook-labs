"""Run the single-use combined Prompt v11 Q04 checkpoint."""
...
from src.combined_prompt_v11_real_runner import (  # noqa: E402
    execute_validation_v11,
    validate_real_request_v11,
)
...
def main() -> int:
    ...
    try:
        authority = validate_real_request_v11(
            model=args.model,
